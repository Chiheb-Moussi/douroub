    ...
    <section>
        ...
        <div class="activities-container mt-25 p-20 p-lg-35">
            <div class="row">
                ...
                <div class="col-4  d-flex align-items-center justify-content-center mt-5 mt-md-0">
                    <div class="d-flex flex-column align-items-center text-center">
...
@push('scripts_bottom')
    ...
    <script src="/assets/default/js/parts/contact-info.min.js"></script>
    <script src="/assets/default/js/parts/reserve_meeting.min.js"></script>
@endpush
