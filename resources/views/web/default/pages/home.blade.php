...
@section('content')
        ...
        <section style="margin-bottom:10px; background-image: url('/assets/default/img/home/world.png');">
            ...
            <div class="container user-select-none">
                    ...
                    <div class="row slider-content align-items-center hero-section2 flex-column-reverse flex-md-row">
                        <div class="col-12 col-md-7 col-lg-4">
                            <h1 class="text-secondary font-weight-bold">Tunisie Abajim   Platforme</h1>
                            <p class="slide-hint text-gray mt-20">eLearning, or electronic learning, is the delivery of learning and training through digital resources. Although eLearning is based on formalized learning, it is provided through electronic devices such as computers, tablets and even cellular phones that are connected to the internet.</p>

                           
                        </div>
                        <div class="col-12 col-md-5 col-lg-4">
                          
                                <lottie-player src="/store/1/18365-animaton-for-e-learning-web-site.json" background="transparent" speed="1" style="width: 100%;" loop autoplay></lottie-player>
                            
                                <!-- <img src="/store/1/online-course.jpg" alt="" class="img-cover"> -->
    ...
    <div class="stats-container" style="margin-top: 129px;">
        <div class="container">
            <div class="row">
    ...
    @endif
        ...
        <section class="home-sections home-sections-swiper container">
            ...
            <p class="section-hi    nt">{{ trans('home.trending_categories_hint') }}</p>
        ...
        <div class="home-sections container">
            <div class="row">
                    ...
                    <div class="col-6">
                        <a href="">
                            <img src="store/1/default_images/banners/validate_certificates_banner.png" class="img-cover rounded-sm" alt="banner meeting">
                        </a>
                    </div>
                    <div class="col-6">
                        <a href="/">
                            <img src="store/1/default_images/banners/reserve_a_meeting.png" class="img-cover rounded-sm" alt="mes">
                        </a>
                    </div>
